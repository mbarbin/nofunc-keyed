...
val find_first : 'elt t -> f:('elt -> bool) -> 'elt
...
val find_first_opt : 'elt t -> f:('elt -> bool) -> 'elt option
...
(** [find_last s ~f], where [f] is a monotonically decreasing function, returns
    ...
    such element exists. *)
val find_last : 'elt t -> f:('elt -> bool) -> 'elt
...
(** [find_last_opt s ~f], where [f] is a monotonically decreasing function,
    ...
    or [None] if no such element exists. *)
val find_last_opt : 'elt t -> f:('elt -> bool) -> 'elt option
...
val filter_map : 'elt t -> f:('elt -> 'elt option) -> 'elt t
...
(** [split s x] returns a triple [(l, present, r)], where [l] is the set of
    ...
    to [x]. *)
val split : 'elt t -> 'elt -> 'elt t * bool * 'elt t
...
val to_seq_from : 'elt t -> 'elt -> 'elt Seq.t
...
val add_seq : 'elt t -> 'elt Seq.t -> 'elt t
